...
<img width="1920" height="1200" alt="61" src="https://github.com/user-attachments/assets/0984db83-2395-4a57-bbce-ea35bff807e1" />


## Техническая логика.

**Программа состоит из 3 информационных слоёв плюс слой двоичное представление адреса.**
	**Веса разрядов (dec):** Зелёная линия вес (DEC) можно определить смещение внутри страницы жёлтый адрес до головы страницы 128 байт. Красный адрес до головы 1916 байт (средина страницы). Розовая линия номер набора с 6 по 11 разряд (номер набора 2 \ 29). 
Синяя линия номер разряда. 4 линия 5 и так далее это двоичное представление адреса памяти. Сколько адресов введём столько и будет линий.
Выровненый массив на 16 интов адрес жёлтого цвета мы видим выровнен по кэш-линии **СКОРОСТЬ**
Случайный массив на 16 интов адрес красного цвета этот массив лежит в хвосте кэш-линии 
**Падение производительности** Массив рвётся на две части одна часть в первой линии другая часть массива ложится во вторую кеш-линию. Поход в память за второй линией процессор ждёт заряд разряд конденсаторов, доп разряд акб критично для мобильных устройств и т.д.
