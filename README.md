...
## Пример анализа.
	...
	![...]
	![Пример работы](Screenshot_20260416-223435.png)
  	![Пример работы](Screenshot_20260416-223403.png) 
	![...]
	Компилируем программы в Termux `clang file.c -o file` или `gcc file.c -o file`
	Запуск `./file`
	Жёлтый выровненый по кэш-линии, красный адрес случайный.
	![...]
	![Пример работы](Screenshot_20260416-223316.png) 
	![...]
	Теперь запуск утилиты и проверка работоспособности 
	![...] 
	![Пример работы](Screenshot_20260416-224237.png)
	![...] 
