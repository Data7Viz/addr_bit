...
Основной акцент сделан на выравнивание по кеш-линии (64 бита). Программа позволяет визуально определить , попадает ли адрес в начало ("Голову") кеш-линии, что является критически важным для производительности.
## Установка и запуск
